                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                     <tr v-for="product in products.data" :key="product.id">
                      ...
                      <td>{{product.section_id != null && tags[product.section_id] != null ? tags[product.section_id].name : ''}}</td>
                      <td>{{product.category ? product.category.name : ''}}</td>
                      <td>{{product.price}}</td>
                      <td><img v-bind:src="'/upload/' + product.photo" width="100" alt="product"></td>
                      <td>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="form.section_id">
                              <option 
                                  ...
                                  :value="index"
                                  :selected="index == form.section_id">{{ tag.name }}</option>
                            </select>
      ...
      components: {
        ...
        methods: {
          updateImage(event){
            ...
            data.append('file', this.form.photo);
            axios.post("api/product/upload", data)
                  .then(response => {
                    this.form.photo = response.data.data;
                  }).catch(err => {
                    this.file_upload = 'error';
                  });
          },
          ...
          getResults(page = 1) {
              ...
              axios.get('api/product?b=' + page).then(({ data }) => (this.products = data.data));
          ...
          createProduct(){
              ...
              let temp = 0;
              this.products.data.map((value, index) => {
              ...
              if (temp == 1) {
                ...
                Toast.fire({
                    icon: 'error',
                    title: 'Product is already exist! Please try again'
                });
              } else {
                this.$Progress.start();
