                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                     <tr v-for="tag in tags.data" :key="tag.id">
                      ...
                      <td><img v-bind:src="'/Gallery/' + tag.image" width="100" alt="product"></td>
        ...
        <div class="modal fade" id="addNew" tabindex="-1" role="dialog" aria-labelledby="addNew" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editmode">Create New Gallery</h5>
                    <h5 class="modal-title" v-show="editmode">Update Gallery</h5>
...
<script>
    export default {
        ...
        updateImage(event){
            ...
            axios.post("/api/gallery/upload", data)
                  .then(response => {
                ...
                Swal.fire({
                  ...
                  confirmButtonText: 'Yes, delete it!'
                      ...
                      // Send request to the server
                        if (result.value) {
                              this.form.delete('/api/gallery/'+id).then((res)=>{
                                      Swal.fire(
                                      'Deleted!',
            ...
            getResults(page = 1) {
                  ...
                  axios.get('/api/gallery?page=' + page).then(({ data }) => (this.tags = data.data));
            ...
            updateTag(){
                ...
                if(temp == 1) {
                    ...
                    Toast.fire({
                        icon: 'error',
                        title: 'Gallery is already exist.'
                    });
                } else {
                    this.$Progress.start();
